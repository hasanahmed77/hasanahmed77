...
- 💡 Focused on SWE and AI Engineering + scalable backend systems for real-world applications  
- 🧩 Strong problem-solver with an emphasis on system design and clean architecture  
- 🏗️ Builder of production-style applications (backend systems, AI apps, embedded systems)  
- 📚 Continuously improving Data Structures, Algorithms, and System Design  
- 🎯 Preparing for Software Engineering / AI Engineer roles (Internationally)  
- 🚀 Passionate about building real systems that solve meaningful problems  

---

## 💻 Projects

- AI Personalized Worksheet Generator  
- E-commerce Website (JWT Authentication + MySQL)  
- Backend System with Redis & Celery (Async Task Processing)  
- Web-Controlled RC Car System  
